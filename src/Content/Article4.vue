<template>
  <div>
     <div id="wide_content">
 <br><i>Самое длинное немецкое слово</i>
    <img src="images/word.jpg" alt="555" style="position:relative;float:right;width:250px;height:150px">
 <p> На вопрос, что больше всего пугает в изучение немецкого языка, ответы могут быть разные. Лидирующие позиции в этом опросе, безусловно, займут грамматика, ну и чтение некоторых слов, поскольку это тот язык, где есть много очень длинных слов.
</p>
